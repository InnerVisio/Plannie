...
const Navigation = () => {
  ...
  return (
    <>
      <nav className="bg-slate-900/80 backdrop-blur-2xl border-b border-white/10 sticky top-0 z-50 pt-[env(safe-area-inset-top)]">
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-slate-900/95 backdrop-blur-xl pt-[calc(73px+env(safe-area-inset-top))] px-4">
...
export default function App() {
  return (
    <AuthProvider>
      <BrowserRouter>
        <div className="h-[100dvh] flex flex-col bg-slate-900 font-sans selection:bg-indigo-500/30 overflow-hidden">
          <Navigation />
